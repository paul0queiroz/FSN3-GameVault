const products = [
  ...
  },
  {
    ...
    "description": "Revolucionário título da franquia com Leon enfrentando o horror em um vilarejo europeu.",
    "price": "136.90",
  ...
  },
  {
    "id": 8,
    "name": "Doom (1983)",
    "description": "O lendário jogo de tiro em primeira pessoa que definiu o gênero.",
    "price": "211.90",
  ...
  },
  {
    ...
    "description": "Corridas urbanas com perseguições policiais e carros tunados.",
    "price": "64.90",
  ...
  },
  {
    "id": 11,
    "name": "A Bug's Life",
    "description": "Acompanhe Flik, um formiga inventiva em busca de heróis para salvar sua colônia dos terríveis gafanhotos. Embarque numa aventura cheia de ação, puzzles criativos e cenários vibrantes inspirados no filme da Disney/Pixar. Explore folhas gigantes, se esgueire por cantos escondidos e descubra que até o menor dos heróis pode fazer uma grande diferença.",
    "price": "70.29",
    "image": "https://upload.wikimedia.org/wikipedia/en/8/83/A_Bug%27s_Life_Coverart.png",
    "category": "Plataforma"
  },
  {
    "id": 12,
    "name": "Kensei: Sacred Fist",
    "description": "Lute com mestres das artes marciais em combates intensos que misturam técnica, velocidade e pura vontade. Escolha entre diversos guerreiros, cada um com seu próprio estilo de luta autêntico, e desafie oponentes em arenas cheias de energia oriental. Com animações fluidas e golpes realistas, este é o jogo que celebra o verdadeiro espírito do combate mano a mano.",
    "price": "45.90",
    "image": "https://upload.wikimedia.org/wikipedia/en/2/29/KenseiSacredFist_NAfrontcover.png",
    "category": "Luta"
  },
  {
    "id": 13,
    "name": "God of War",
    "description": "O primeiro título da lendária franquia coloca você na pele de Kratos, um guerreiro espartano atormentado por seu passado. Após ser manipulado por Ares, o Deus da Guerra, e acabar assassinando sua própria família, Kratos busca redenção e vingança.",
    "price": "50",
  ...
  },
  {
    ...
    "price": "82.90",
    "image": "https://upload.wikimedia.org/wikipedia/en/a/a8/The_Secret_of_Monkey_Island_artwork.jpg",
    "category": "Aventura"
  },
  {
    "id": 16,
    "name": "Resident Evil",
    "description": "ançado originalmente em 1996 pela Capcom, este é o jogo que definiu o gênero survival horror. Você assume o papel de Chris Redfield ou Jill Valentine, membros da equipe S.T.A.R.S., enviados para investigar assassinatos misteriosos nas Montanhas Arklay, nos arredores de Raccoon City.",
    "price": "76.90",
    "image": "https://upload.wikimedia.org/wikipedia/en/a/a6/Resident_Evil_1_cover.png",
    "category": "Survival Horror"
  },
  {
    "id": 17,
  ...
  },
  {
    ...
    "description": "A sequência direta de The Secret of Monkey Island, este clássico da LucasArts leva o aspirante a pirata Guybrush Threepwood em uma nova e hilária jornada para encontrar o lendário tesouro de Big Whoop.",
    "price": "43.90",
  ...
  },
  {
    "id": 19,
    "name": "Twisted Metal",
    "description": "Twisted Metal 1 (1995 – PlayStation 1) O primeiro jogo da icônica franquia de combate veicular da Sony, Twisted Metal coloca os jogadores em uma competição mortal chamada Twisted Metal Tournament, onde o vencedor tem direito a realizar um desejo qualquer — mas com consequências imprevisíveis.",
    "price": "48.90",
  ...
  },
  {
    ...
    "description": "Ambientado em Raccoon City durante o surto do T-Vírus, o jogo permite que você controle um dos oito civis sobreviventes, cada um com habilidades únicas, enquanto tenta escapar da cidade infestada de zumbis e criaturas mutantes.",
    "price": "93.90",
  ...
  },
  {
    ...
    "description": "O jogo que deu origem ao gênero 4X (eXplore, eXpand, eXploit, eXterminate), Civilization permite que você construa uma civilização desde 4000 a.C. até o futuro, guiando-a por meio de descobertas científicas, diplomacia, guerras e construção de maravilhas.",
    "price": "85.90",
    "image": "https://upload.wikimedia.org/wikipedia/en/e/ec/Civilizationboxart.jpg",
    "category": "Estratégia"
  },
  {
    "id": 23,
    "name": "The Sims",
    "description": "The Sims revolucionou os jogos ao permitir que os jogadores simulassem a vida cotidiana de personagens virtuais chamados Sims. Sem objetivos fixos ou “chefões”, o jogo oferece liberdade total para construir casas, desenvolver relacionamentos, seguir carreiras e cuidar das necessidades básicas dos Sims — tudo isso em um ambiente interativo e cheio de possibilidades.",
    "price": "63.90",
  ...
  },
  {
    ...
    "price": "68.90",
    "image": "https://upload.wikimedia.org/wikipedia/en/d/d4/SimCity_2000_Coverart.png",
    "category": "Simulação"
  },
  {
    "id": 25,
  ...
  },
  {
    "id": 28,
    "name": "Chrono Cross",
    "description": "Desenvolvido pela Square como sucessor espiritual de Chrono Trigger, Chrono Cross é um RPG profundo e poético que explora realidades paralelas, identidade e destino. Você controla Serge, um jovem que descobre que morreu em outra dimensão e embarca numa jornada para entender essa divergência — enfrentando o sombrio Lynx, buscando a misteriosa Frozen Flame, e cruzando caminhos com a ladra carismática Kid.",
    "price": "61.90",
  ...
  },
  {
    ...
    "description": "Mortal Kombat é o jogo que iniciou uma das franquias mais icônicas e controversas dos videogames. Com gráficos digitalizados de atores reais e uma violência gráfica inédita para a época, o jogo se destacou por sua atmosfera sombria, personagens marcantes e os famosos Fatalities — movimentos de finalização brutais que se tornaram marca registrada da série.",
    "price": "42.90",
  ...
  },
  {
    ...
    "price": "159.90",
    "image": "https://upload.wikimedia.org/wikipedia/en/e/e1/PC-98_Policenauts_box.jpg",
    "category": "Aventura"
  },
  {
    "id": 32,
    "name": "Ninja Gaiden (NES)",
    "description": "Ninja Gaiden é um dos jogos mais icônicos da era 8-bits. Você controla Ryu Hayabusa, um jovem ninja que viaja aos Estados Unidos para investigar o desaparecimento de seu pai e acaba envolvido em uma trama sombria envolvendo estátuas demoníacas, conspirações globais e uma ameaça ancestral.",
    "price": "127.90",
    "image": "https://upload.wikimedia.org/wikipedia/en/9/9b/Ninja_Gaiden_%28NES%29.jpg",
    "category": "Ação"
  },
  {
    "id": 33,
    "name": "The Legend of Zelda",
    "description": "The Legend of Zelda é o jogo que deu início a uma das franquias mais influentes da história dos videogames. Você controla Link, um jovem herói que deve resgatar a Princesa Zelda e derrotar o maligno Ganon, reunindo os fragmentos da Triforce da Sabedoria espalhados pelo reino de Hyrule.",
    "price": "130.90",
  ...
  },
  {
    ...
    "description": "A história se passa no continente de Valentia, dividido entre os reinos de Zofia e Rigel, governados pelos deuses Mila e Duma. Você controla dois protagonistas — Alm e Celica — em campanhas paralelas que buscam restaurar a paz e enfrentar os efeitos da corrupção divina.",
    "price": "68.90",
  ...
  },
  {
    ...
    "description": "A história começa no Antigo Egito, com o Príncipe Atem enfrentando conspirações mágicas e duelos intensos. Após ser selado no Enigma do Milênio, ele desperta no futuro como Yugi Mutou, participando de um torneio da KaibaCorp para reunir os Itens do Milênio e salvar o mundo.",
    "price": "47.00",
  ...
  },
  {
    ...
    "description": "Explore o icônico Reino dos Cogumelos com Mario, o encanador mais famoso do mundo dos games! Pule obstáculos, enfrente inimigos e resgate a Princesa Peach das garras do terrível Bowser. Com fases desafiadoras, trilha sonora marcante e jogabilidade envolvente, Super Mario Bros é uma jornada nostálgica e imperdível para jogadores de todas as idades.",
    "price": "23.90",
    "image": "https://upload.wikimedia.org/wikipedia/pt/0/03/Super_Mario_Bros._box.png",
    "category": "Plataforma"
  },
  {
    "id": 42,
    "name": "The Legend of Zelda: A Link to the Past",
    "description": "Embarque numa épica aventura de fantasia com Link, o jovem guerreiro destinado a enfrentar as forças das trevas e salvar o Reino de Hyrule. Descubra mundos paralelos, enigmas envolventes e masmorras traiçoeiras enquanto empunha a lendária Master Sword em busca da verdade e da princesa Zelda.",
    "price": "29.90",
    "image": "https://upload.wikimedia.org/wikipedia/pt/thumb/3/31/The_Legenda_of_Zelda_A_Link_to_the_Past_capa.png/330px-The_Legenda_of_Zelda_A_Link_to_the_Past_capa.png",
    "category": "Ação-Aventura"
  },
  {
    "id": 43,
    "name": "Donkey Kong Country",
    "description": "Prepare-se para uma aventura eletrizante com Donkey Kong e seu parceiro Diddy em uma missão para recuperar seu tesouro de bananas roubado! Com gráficos inovadores, trilha sonora vibrante e uma jogabilidade cheia de ação, Donkey Kong Country é uma explosão de diversão nas profundezas da selva.",
    "price": "44.90",
  ...
  },
  {
    "id": 44,
    "name": "F-Zero",
    "description": "Enfrente pilotos implacáveis em pistas futuristas a bordo de veículos antigravitacionais que desafiam as leis da física! F-Zero é pura ação acelerada, com gráficos ousados para sua época, trilha sonora marcante e uma experiência de corrida que moldou o gênero.",
    "price": "28.90",
    "image": "https://upload.wikimedia.org/wikipedia/en/9/9b/SNES_F-Zero_boxart.jpg",
    "category": "Corrida"
  },
  {
    "id": 45,
    ...
    "price": "59.90",
    "image": "https://upload.wikimedia.org/wikipedia/en/1/1c/Shinobi_III_Return_of_the_Ninja_Master.jpg",
    "category": "Ação"
  },
  {
    "id": 46,
    "name": "Gunstar Heroes",
    "description": "Entre de cabeça em uma batalha frenética com os irmãos Gunstar, em uma luta desesperada para impedir que uma força maligna conquiste o mundo! Com ação cooperativa vibrante, visuais marcantes e uma variedade insana de armas e habilidades, Gunstar Heroes é adrenalina pura do início ao fim.",
    "price": "33.90",
  ...
  },
  {
    "id": 51,
    "name": "Kingdom Hearts",
    "description": "Junte-se a Sora, Donald e Pateta em uma jornada inesquecível por mundos encantados e sombrios, enfrentando criaturas das trevas enquanto busca por seus amigos perdidos. Kingdom Hearts mistura ação, emoção e narrativa envolvente, combinando personagens icônicos, cenários deslumbrantes e batalhas épicas em tempo real.",
    "price": "79.90",
  ...
  },
  {
    "id": 52,
    "name": "Parasite Eve",
    "description": "Viaje pelas ruas sombrias de Nova York em uma trama onde ciência e horror se misturam. Assuma o papel da agente Aya Brea, enquanto enfrenta mutações grotescas causadas por uma entidade que desafia a evolução humana. Parasite Eve combina combate tático em tempo real, narrativa adulta e atmosfera inquietante, criando uma experiência única que mescla RPG e survival horror.",
    "price": "69.90",
    "image": "https://upload.wikimedia.org/wikipedia/en/3/3f/Parasite_Eve_Coverart.png",
    "category": "RPG de Sobrevivência"
  },
  {
    "id": 53,
    "name": "Jurassic Park (SNES)",
    "description": "Baseado no icônico filme de Steven Spielberg, Jurassic Park para Super Nintendo coloca você na pele do Dr. Grant em uma missão desesperada dentro de uma ilha infestada por dinossauros fora de controle. Com visão aérea e sequências em primeira pessoa, o jogo mistura exploração, tensão e ação, desafiando sua astúcia e reflexo a cada passo.",
    "price": "68.90",
    "image": "https://upload.wikimedia.org/wikipedia/en/d/d0/Jurassic_Park_SNES_NA.jpg",
    "category": "Ação-Aventura"
  },
  {
    "id": 54,
    "name": "Resident Evil – Code: Veronica",
    "description": "Continue a saga sangrenta da série Resident Evil com Claire Redfield, agora presa em uma instalação remota cheia de segredos obscuros e horrores biológicos. Ao lado de novos aliados e enfrentando inimigos ainda mais insanos, Code: Veronica mergulha o jogador em uma narrativa sombria de genética, poder e monstros inesquecíveis — tudo com a tensão e atmosfera que só Resident Evil sabe entregar.",
    "price": "55.90",
  ...
  },
  {
    ...
    "price": "27.90",
    "image": "https://upload.wikimedia.org/wikipedia/en/thumb/e/e6/JackieChanStuntmaster.jpg/250px-JackieChanStuntmaster.jpg",
    "category": "Beat 'em up"
  },
  {
    "id": 78,
    "name": "Tactics Ogre",
    "description": "Mergulhe em um mundo devastado pela guerra civil, onde suas escolhas moldam o destino de nações. Tactics Ogre (1995) é um RPG tático profundo e envolvente, que combina batalhas em turnos com uma narrativa madura e cheia de reviravoltas. Com múltiplos caminhos, personagens complexos e um sistema de classes robusto, este clássico cult é referência absoluta no gênero e precursor de muitos sucessos modernos.",
    "price": "64.90",
    "image": "https://upload.wikimedia.org/wikipedia/en/4/40/SFC_Tactics_Ogre_-_Let_Us_Cling_Together_cover_art.jpg",
    "category": "RPG Tático"
  },
  {
    "id": 79,
    "name": "Final Fantasy Tactics",
    "description": "Em um reino marcado por intrigas políticas e batalhas sangrentas, Final Fantasy Tactics leva você a uma jornada inesquecível de honra, traição e poder. Com um sistema de combate tático refinado, dezenas de classes para personalizar seu exército e uma história densa e emocionante, este spin-off da lendária franquia Final Fantasy redefiniu o gênero dos RPGs estratégicos.",
    "price": "39.90",
